  ...
  if (isLoading.platform) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <section className="relative h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-900 via-teal-900 to-green-900">  
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">  
            <Skeleton className="h-8 w-48 mx-auto mb-6" />  
            <Skeleton className="h-16 sm:h-20 w-3/4 mx-auto mb-6" />  
            <Skeleton className="h-6 sm:h-8 w-2/3 mx-auto mb-6" />  
