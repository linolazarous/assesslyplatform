...
import { 
  Assessment, People, Business, CheckCircle, Sync, Lock, PieChart, DragIndicator, VerifiedUser, Security
...
export default function FeaturesSection() {
  ...
  return (
    <Box component="section" sx={{ py: 8 }} id="features-section">
      ...
      {/* --- Assessment Types and Platform Highlights --- */}
      <Grid container spacing={4} alignItems="stretch">
        ...
        {/* Right Column: Platform Flow (Mermaid Diagram equivalent) */}
